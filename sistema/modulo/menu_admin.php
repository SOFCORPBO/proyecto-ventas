    ...
    <div class="container">
        <div class="navbar-header">
            <div class="navbar-brand">
                <a href="<?php echo URLBASE ?>" class="navbar-brand"><img src="<?php echo ESTATICO ?>img/store.png"
                        alt="Logo <?php echo TITULO ?>" width="40px" /></a>
            </div>
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
            <ul class="nav navbar-nav">
                <li class="menu" id="reviewsMenu">
                    <a href="index.php">POS VENTA</a>
                </li>
                <li class="dropdown menu">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="download">Kardex <span
                            class="caret"></span></a>
                ...
                <li class="dropdown menu">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="download">Productos <span
                            class="caret"></span></a>
                    <ul class="dropdown-menu" aria-labelledby="download">
                        <li><a href="<?php echo URLBASE ?>productos">Catalogo de servicios</a></li>
                ...
                <li class="dropdown menu">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="download">VENTA DE SERVICIOS <span
                            class="caret"></span></a>
                    <ul class="dropdown-menu" aria-labelledby="download">
                ...
                <li class="dropdown menu">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="download">Usuarios <span
                            class="caret"></span></a>
                    <ul class="dropdown-menu" aria-labelledby="download">
                ...
                <li class="dropdown menu">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="download">Sistema<span
                            class="caret"></span></a>
                    <ul class="dropdown-menu" aria-labelledby="download">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown menu">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes">Cuenta <span
                            class="caret"></span></a>
