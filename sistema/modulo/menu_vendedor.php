	...
	<div class="container">
		<div class="navbar-header">
			<div class="navbar-brand">
				<a href="<?php echo URLBASE ?>" class="navbar-brand"><img src="<?php echo ESTATICO ?>img/logo.png" alt="Logo <?php echo TITULO ?>" width="230px"/></a>
			</div>
		...
		<div class="navbar-collapse collapse" id="navbar-main">
			<ul class="nav navbar-nav">
				<li class="menu" id="reviewsMenu"><a href="index.php">Inicio</a></li>
