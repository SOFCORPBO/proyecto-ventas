...
class Tramites extends Conexion {
    ...
    public function Guardar($post)
    {
        ...
        if ($id_cliente <= 0 || $tipo == '') {
            return ['ok'=>false, 'msg'=>'Debe seleccionar un cliente y tipo de trámite.'];
        }
    ...
    {
        return $this->db->SQL("SELECT id, nombre FROM cliente WHERE habilitado=1 ORDER BY nombre ASC");
    }
}