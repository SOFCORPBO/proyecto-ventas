                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <select class="form-control clientes" value="Cliente Contado" name="cliente"
                                            id="select" required
                                            <?php if($ComprobarCierreCaja['tipo']==2): echo'disabled'; else: endif;?>>
                                            <?php foreach($SelectorClientesArray as $SelectorClientesRow): ?>
                                            <option value="<?php echo $SelectorClientesRow['id']; ?>"
                                                <?php if($SelectorClientesRow['id']==1){echo'selected="selected"';}else{} ?>>
                                                <?php echo $SelectorClientesRow['nombre']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="inputEmail3"
                                                value="<?php echo FechaActual(); ?>" required disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="number" min="1" step="1" maxlength="6" class="form-control"
                                                name="cantidad" id="cantidad" placeholder="Cantidad" value="1"
                                                onkeypress="return PermitirSoloNumeros(event);" autocomplete="off"
                                                required
                                                <?php if($ComprobarCierreCaja['tipo']==2): echo'disabled'; else: endif;?> />
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <button type="button" class="btn btn-primary btn-block" data-container="body"
                                            ...
                                            data-content="No a realizado la apertura de caja, haz la apertura para poder facturar."
                                            data-original-title="Apertura de Caja" title="Apertura de Caja"
                                            aria-describedby="Pr&eacute;stamo Cancelado">
                                            Agregar Producto
                                        </button>
                                        <?php else:?>
                                        <button type="submit" name="Submit" value="Grabar"
                                            class="btn btn-primary btn-block"><i class="fa fa-plus"></i> Agregar
                                            Producto</button>
                                        <?php endif;?>
                                    </div>
                                </div>
